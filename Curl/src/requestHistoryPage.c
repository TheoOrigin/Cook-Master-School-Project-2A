...
void request_history_page(GtkButton *button, gpointer content)
{
    ...
    // Create a GtkTreeView widget to display the data model
    GtkWidget *treeview = gtk_tree_view_new_with_model(GTK_TREE_MODEL(store));

    // Create the columns with their titles
    ...
    // Add the table to a parent container
    // Here, we use a GtkScrolledWindow container to be able to scroll the table entries
